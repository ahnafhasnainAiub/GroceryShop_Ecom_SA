...
const createProduct = async (req, res, next) => {
  try {
    const { name, image, description, brand, category, price, discountPrice, countInStock } = req.body;

    // Create a new product with the discountPrice field
    const product = new Product({
      ...
      category,
      price,
      discountPrice, // Include discountPrice
      countInStock,
    });
...
const updateProduct = async (req, res, next) => {
  try {
    ...
    product.discountPrice = discountPrice || product.discountPrice; // Update discountPrice
...
export { getProducts, getProduct, createProduct, updateProduct, deleteProduct, createProductReview, getTopProducts };
