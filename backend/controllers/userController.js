...
const resetPasswordRequest = async (req, res, next) => {
  try {
    ...
    await transporter.sendMail({
      from: `"My Grocery Shop" ${process.env.EMAIL_FROM}`, // sender address
      ...
      html: `<p>Hi ${user.name},</p>
            ...
            <p>Thanks,<br>
            My Grocery Shop Team</p>`, // html body
    });
...
export { loginUser, registerUser, logoutUser, getUserProfile, getUsers, getUserById, updateUser, updateUserProfile, deleteUser, admins, resetPasswordRequest, resetPassword };
