    ...
    <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        ...
        <Form.Group className="mb-3" controlId="postalCode">
          ...
          <Form.Control value={postalCode} type="text" placeholder="Enter city" onChange={(e) => setPostalCode(e.target.value)} />
        </Form.Group>
        <Form.Group className="mb-3" controlId="country">
          <Form.Label>Country</Form.Label>
          <Form.Control value={country} type="text" placeholder="Enter city" onChange={(e) => setCountry(e.target.value)} />
        </Form.Group>
