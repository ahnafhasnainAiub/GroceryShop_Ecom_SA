...
const PlaceOrderPage = () => {
  const { cartItems, shippingAddress, paymentMethod, itemsPrice, taxPrice, shippingPrice, totalPrice } = useSelector((state) => state.cart);
  ...
  const placeOrderHandler = async () => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire("Placed!", "Your order has been placed successfully.", "success");
      } catch (error) {
        ...
        <Col md={8}>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
              ...
              <br />
              <strong>bKash Number:</strong> {paymentMethod === "bKash" && localStorage.getItem("bkash")}
            </ListGroup.Item>
            <ListGroup.Item>
              <h2>Order Items</h2>
              <ListGroup variant="flush">
        ...
        <Col md={4}>
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Button className="w-100" variant="warning" disabled={cartItems.length === 0 || isLoading} onClick={placeOrderHandler}>
                  Place Order
                </Button>
              </ListGroup.Item>
            </ListGroup>
