...
const LoginPage = () => {
  ...
  const adminRedirect = searchParams.get("redirect") || "/admin/dashboard";
  ...
  }, [userInfo, redirect, navigate, adminRedirect]);
        ...
        <Row>
          <Col>
            <Form.Group className="mb-3" controlId="checkbox">
              <Form.Check type="checkbox" label="Keep me signed in." checked={remember} onChange={() => setRemember(!remember)} />
            </Form.Group>
          </Col>
